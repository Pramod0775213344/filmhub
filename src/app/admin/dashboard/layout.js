...
// import LoadingSpinner from "@/components/LoadingSpinner"; // User requested removal
import { UploadProvider } from "@/context/UploadContext";
import GlobalUploadWidget from "@/components/admin/GlobalUploadWidget";
...
export default function DashboardLayout({ children }) {
  ...
  // const [loading, setLoading] = useState(true); // User requested removal of blocking loader
  ...
  // Removed blocking loader as per request
