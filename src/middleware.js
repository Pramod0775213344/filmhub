...
export async function middleware(request) {
  ...
  const cspDirectives = [
    ...
    "connect-src 'self' https://*.supabase.co https://www.google-analytics.com https://analytics.google.com https://generativelanguage.googleapis.com https://analyticsdata.googleapis.com https://image.tmdb.org https://api.themoviedb.org wss://*.supabase.co",
